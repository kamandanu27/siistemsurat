          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-success">
                ...
                <!-- form start -->
                <form action="<?php echo base_url() ?>pengaturan/insert" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="row">
                      <div class="form-group">
                        <label class="col-md-3" for="ttl">Visi</label>
                          <div class="input-group col-sm-8 col-md-8">
                          <input type="text" class="form-control" placeholder="Visi" name="visi" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="input-group col-sm-8 col-md-8">
                            <input type="text" class="form-control" placeholder="Misi" name="misi" required>
                          </div>
                      </div>
