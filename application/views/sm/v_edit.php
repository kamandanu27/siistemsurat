                  ...
                  <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group col-md-8">
                              <input type="text" class="form-control" placeholder="Tanggal Surat" name="tglsurat" value="<?= $data['tglsurat'] ?>" required>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group col-md-8">
                              <input type="text" class="form-control" placeholder="Tanggal Terima" name="tglterima" value="<?= $data['tglterima'] ?>" required>
                          </div>
                        </div>
